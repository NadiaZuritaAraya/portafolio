...
exports.requestAccess = onRequest(
  ...
  async (req, res) => {
    ...
    try {
      ...
      const expireAt = Timestamp.fromMillis(now.toMillis() + TOKEN_TTL_HOURS * 60 * 60 * 1000);
        ...
        html: `
          <div style="font-family:sans-serif;max-width:480px;margin:0 auto;padding:2rem;background:#09090f;color:#f1f0ff;border-radius:12px">
            ...
            <p style="color:#8b8ba0;margin-bottom:1.5rem">
              Has solicitado acceso al portafolio de <strong style="color:#f1f0ff">Nadia Zurita</strong>.
              El siguiente link es válido por <strong style="color:#67e8f9">24 horas</strong>.
            </p>
            <a href="${accessUrl}"
